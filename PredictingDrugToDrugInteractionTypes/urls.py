"""explainable_artificial_intelligence_for_patient_safety URL Configuration
...
from PredictingDrugToDrugInteractionTypes import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Patient_Safety_Detection/$', remoteuser.Predict_Patient_Safety_Detection, name="Predict_Patient_Safety_Detection"),
    ...
    url(r'^View_Prediction_Of_Patient_Safety_Detection_Ratio/$', serviceprovider.View_Prediction_Of_Patient_Safety_Detection_Ratio, name="View_Prediction_Of_Patient_Safety_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Patient_Safety_Detection/$', serviceprovider.View_Prediction_Of_Patient_Safety_Detection, name="View_Prediction_Of_Patient_Safety_Detection"),
