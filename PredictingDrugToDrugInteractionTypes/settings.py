...
ROOT_URLCONF = 'PredictingDrugToDrugInteractionTypes.urls'
...
WSGI_APPLICATION = 'PredictingDrugToDrugInteractionTypes.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'PredictingDrugToDrugInteractionTypes',
        'USER':'root',
        'PASSWORD': 'root',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
